      ...
      !function () {
        ...
        Xe.prototype.add = function (t, e, n, i, r) {
          ...
          return (
            -1 < a
              ? ((e = t[a]), n || (e.Qa = !1))
              : (((e = new Be(e, this.src, o, !!i, r)).Qa = n), t.push(e)),
            e
          );
        };
        ...
        function ln() {
          Pe.call(this), (this.v = new Xe(this)), ((this.bc = this).hb = null);
        }
        ...
        function hi() {
          return $l.default.INTERNAL.hasOwnProperty("reactNative")
            ? "ReactNative"
            : $l.default.INTERNAL.hasOwnProperty("node")
            ? "Node"
            : ci()
            ? "Worker"
            : "Browser";
        ...
        var xr =
          ...
          jr = {
            nd: { Ja: "locale", va: 700, ua: 600, fa: "facebook.com", Ya: Mr },
            pd: { Ja: null, va: 500, ua: 750, fa: "github.com", Ya: Mr },
            qd: { Ja: "hl", va: 515, ua: 680, fa: "google.com", Ya: Mr },
            wd: { Ja: "lang", va: 485, ua: 705, fa: "twitter.com", Ya: xr },
              ...
              var t = m(i) ? i.session : null,
                ...
                t =
                  t && t.type == zr
                    ...
                    : Xs(o, Ds, { phoneNumber: n, recaptchaToken: e });
              return t.then(
                function (t) {
        ...
        function ga(e) {
          if (e.c && void 0 !== h)
            ...
            else if (e.i && 4 == wa(e)) vn(e.Wb, 0, e);
        ...
        ((t = ca.prototype).Ma = function () {
          ...
          (t.Wb = function () {
            this.ya || (this.N || this.i || this.f ? ga(this) : this.Jc());
          }),
          (t.Jc = function () {
            ga(this);
          }),
        ...
        function Fa(t, e, n) {
          if (
            ...
            !(n =
              l.XMLHttpRequest ||
              (n &&
                $l.default.INTERNAL.node &&
                $l.default.INTERNAL.node.XMLHttpRequest)) && !ci())
          )
            throw new T(
              "internal-error",
        ...
        ((t = Fa.prototype).Eb = function (t, i) {
          var r = { idToken: t },
            o = [];
          return (
            st(os, function (t, e) {
        ...
        var ps = { endpoint: "setAccountInfo", A: ds, Z: "email", B: !0 },
          ...
          bs = { endpoint: "deleteAccount", O: ["idToken"] },
          ys = {
          ...
          Os = { mb: !0, endpoint: "getProjectConfig", Vb: "GET" },
          Cs = {
            mb: !0,
          ...
          Ps = { endpoint: "setAccountInfo", O: ["idToken"], A: ns, V: !0 },
          Ls = {
            endpoint: "setAccountInfo",
            O: ["idToken"],
            A: function (t) {
          ...
          return ye(n)
            ...
            .then(function () {
              return (
                ...
                ts(t, r ? t.i : t.h, e.endpoint, o, n, e.Ib, e.mb || !1)
              );
            })
            .then(function (t) {
        ...
        function iu(t) {
          try {
            return $l.default.app(t).auth().Ga();
          } catch (t) {
            return [];
          }
        }
        ...
        function cu(t) {
          if (
            ((this.a =
              t ||
              ($l.default.INTERNAL.reactNative &&
                $l.default.INTERNAL.reactNative.AsyncStorage)),
            !this.a)
          )
            throw new T(
              "internal-error",
        ...
        (eu.prototype.toString = function () {
          ...
          (nu.prototype.toString = function () {
            ...
            if (
              ...
              var e = this.a;
              try {
                var n = $l.default.app(this.c).auth().la();
              } catch (t) {
                n = null;
              }
              for (i in ((e.pb = n),
          ...
          ((t = ru.prototype).Pb = function (e, n, t) {
        ...
        function Ru() {
            ...
            !(function () {
              ...
              if (
                !(t =
                  ...
                  (t &&
                    $l.default.INTERNAL.node &&
                    $l.default.INTERNAL.node.localStorage))
              )
                return !1;
              try {
          ...
          (this.a = Du() || $l.default.INTERNAL.node.localStorage),
        ...
        function Lu() {
            ...
            !(function () {
              ...
              if (
                !(t =
                  ...
                  (t &&
                    $l.default.INTERNAL.node &&
                    $l.default.INTERNAL.node.sessionStorage))
              )
                return !1;
              try {
                return t.setItem("__sak", "1"), t.removeItem("__sak"), !0;
          ...
          (this.a = xu() || $l.default.INTERNAL.node.sessionStorage),
        ...
        function Gu() {
          ...
          (this.v = new Cu()), (this.f = b(this.Zb, this)), (this.b = {});
        }
        function Bu() {
          return (Uu = Uu || new Gu());
        }
        ...
        function Ic(t, e, n, i, r) {
          var o = $l.default.SDK_VERSION || null;
        ...
        function Kc(t, e, n, i) {
          return new So(t).gb(e, n).then(function (t) {
            return new Hc(t, i);
          });
        }
        function Gc(t) {
        ...
        function hh(t, e, n) {
          ...
          var i,
            r = $l.default.SDK_VERSION ? mi($l.default.SDK_VERSION) : null;
          (this.a = new Fa(this.l, _(A), r)),
            (this.u = t.emulatorConfig || null) && Ja(this.a, this.u),
            (this.h = new rh(this.a)),
            yh(this, e[Ha]),
            ah(this.h, e),
            Vi(this, "refreshToken", this.h.a),
            Th(this, n || {}),
            ln.call(this),
            (this.P = !1),
            this.s && wi() && (this.b = Lc(this.s, this.l, this.m, this.u)),
            (this.W = []),
            (this.i = null),
            (this.D =
              ((i = this),
          ...
          (this.za = null),
            ...
            (this.ja = null),
            (this.S = new th(this, n)),
            Vi(this, "multiFactor", this.S);
        }
        function lh(t, e) {
          (t.u = e),
            Ja(t.a, e),
            t.b &&
              ((e = t.b),
              (t.b = Lc(t.s, t.l, t.m, t.u)),
              t.P && (kc(e, t), Ac(t.b, t)));
        }
        function fh(t, e) {
          t.qa && en(t.qa, "languageCodeChanged", t.Pa),
            (t.qa = e) && Ze(e, "languageCodeChanged", t.Pa);
        }
        function dh(t, e) {
          t.$ && en(t.$, "emulatorConfigChanged", t.Ba),
            (t.$ = e) && Ze(e, "emulatorConfigChanged", t.Ba);
        }
        function ph(t, e) {
          (t.aa = e),
            za(
              t.a,
              $l.default.SDK_VERSION ? mi($l.default.SDK_VERSION, t.aa) : null
            );
        }
        function vh(t, e) {
          t.ja && en(t.ja, "frameworkChanged", t.Oa),
            (t.ja = e) && Ze(e, "frameworkChanged", t.Oa);
        }
        function mh(e) {
          try {
            return $l.default.app(e.m).auth();
          } catch (t) {
            throw new T(
              "internal-error",
        ...
        function gh(t) {
          t.J ||
            t.D.b ||
            (t.D.start(),
            en(t, "tokenChanged", t.ba),
            Ze(t, "tokenChanged", t.ba));
        }
        function bh(t) {
          en(t, "tokenChanged", t.ba), t.D.stop();
        }
        function yh(t, e) {
          (t.Aa = e), Vi(t, "_lat", e);
        }
        ...
        function Ch(i) {
          return i.I().then(function (t) {
            var e,
              n = i.isAnonymous;
            return Xs((e = i).a, As, { idToken: t })
              .then(b(e.Kc, e))
              .then(function () {
                return n || _h(i, "isAnonymous", !1), t;
              });
          });
        }
        function Rh(t, e) {
        ...
        function xh(n, i, t, e, r) {
          ...
          return (
            (e = e()
              ...
              .then(function () {
                return _c(n.b, u, i, t, a, !!s, n.tenantId);
              })
              .then(function () {
                return new fe(function (t, e) {
        ...
        function Mh(e, t, n, i, r) {
          ...
          return (
            (i = i()
              ...
              .then(function (t) {
                return (t = e.ha ? (t = e.ha).b.set(qh, e.w(), t.a) : t);
              })
              .then(function () {
                return Cc(e.b, t, n, a, e.tenantId);
              })
              .o(function (t) {
                ...
                : t.o(function (t) {
                    throw (
                      (!t ||
                        ...
                        (i.i || i.dispatchEvent(new Qc("userInvalidated")),
                        (i.i = t)),
                      t)
                    );
                  }));
        ...
        (Bc.prototype.Rc = function (t) {
          ...
          w(Jc, T),
          (zc.prototype.tb = function (t, e, n) {
            return e.type == zr
              ? ((o = this),
                (a = t),
                (s = n),
          ...
          w(hh, ln),
          (hh.prototype.xa = function (t) {
            (this.za = t), Xa(this.a, t);
          }),
        ...
        var qh = { name: "redirectUser", F: "session" };
        function Hh(t) {
          return Ju(t.b, qh, t.a);
        }
        function Kh(t) {
          var e, n, i, r;
          (this.a = t),
        ...
        function Gh(t, e) {
          var n,
            s,
            i = [];
          for (n in Ku) Ku[n] !== e && i.push(Ju(t.b, Wh(Ku[n]), t.a));
          return (
            i.push(Ju(t.b, Bh, t.a)),
            (s = i),
            new fe(function (n, e) {
              var i = s.length,
                r = [];
        ...
        var Bh = { name: "persistence", F: "session" };
        function Wh(t) {
        ...
        function $h(t) {
          ...
          var n, e, i, r, o, a;
          (t = $l.default.SDK_VERSION ? mi($l.default.SDK_VERSION) : null),
            (this.a = new Fa(
              this.app.options && this.app.options.apiKey,
              _(A),
              t
            ...
            (this.s = []),
            (this.N = []),
            (this.Pa = $l.default.INTERNAL.createSubscribe(b(this.zc, this))),
            (this.W = void 0),
            (this.ib = $l.default.INTERNAL.createSubscribe(b(this.Ac, this))),
            rl(this, null),
            (this.i = new Kh(this.app.options.apiKey + ":" + this.app.name)),
            (this.D = new Fh(this.app.options.apiKey + ":" + this.app.name)),
            (this.$ = cl(
              this,
            ...
            (this.h = cl(
              ...
              (i = this).$.then(function () {
                ...
                .then(function () {
                  ...
                  i.l ||
                    ((i.ba = !0),
                    (t = i.i).b.addListener(Wh("local"), t.a, i.ja));
                })
            )),
            (this.ba = !1),
            ...
            Object.defineProperty(t, "emulatorConfig", {
              get: function () {
                ...
                return (t = this.R
                  ? qi({
                      protocol: (t = On(this.R.url)).c,
                      host: t.a,
                      port: t.g,
                      options: qi({ disableWarnings: this.R.ec }),
                    })
                  : null);
              },
              enumerable: !1,
        ...
        function rl(t, e) {
          ...
          al(t) &&
            ...
            en(al(t), "tokenChanged", t.qa),
            en(al(t), "userDeleted", t.za),
            en(al(t), "userInvalidated", t.Aa),
            bh(al(t))),
            e &&
              (e.W.push(t.Ba),
              Ze(e, "tokenChanged", t.qa),
        ...
        function sl(t) {
          return (al(t) && al(t)._lat) || null;
        }
        function ul(t) {
          if (t.ba) {
            for (var e = 0; e < t.s.length; e++) t.s[e] && t.s[e](sl(t));
        ...
        (Kh.prototype.yb = function (e) {
          ...
          w(Qh, Fe),
          w(tl, Fe),
          ((t = $h.prototype).yb = function (t) {
            return (t = this.i.yb(t)), cl(this, t);
          }),
          (t.xa = function (t) {
            this.aa === t ||
              this.l ||
              ((this.aa = t),
              Xa(this.a, this.aa),
              this.dispatchEvent(new Zh(this.la())));
          }),
          (t.la = function () {
            return this.aa;
          }),
          ...
          (t.gd = function (t, e) {
            if (!this.R) {
              ...
              (e = !!e && !!e.disableWarnings),
                ...
                (this.settings.jb = !0),
                Ja(this.a, this.R),
                this.dispatchEvent(new Qh(this.R));
            }
            var n;
          }),
          (t.Gc = function (t) {
            this.J.push(t),
              za(
                this.a,
                $l.default.SDK_VERSION
                  ? mi($l.default.SDK_VERSION, this.J)
                  : null
              ),
              this.dispatchEvent(new tl(this.J));
          }),
          (t.Ga = function () {
            return X(this.J);
          }),
          ...
          (t.Yc = function (t) {
            ...
            return cl(
              ...
              el(this)
                .then(function () {
                  return zh((t = e.i), function () {
                    return t.b.set(Bh, t.c.F, t.a);
                  });
                  var t;
                })
                .then(function () {
          ...
          (t.Zc = function () {
            var i = this;
            return Yh(this.i, this.app.options.authDomain).then(function (t) {
              if (!i.l) {
                var e, n;
                if (
                  ((e = al(i) && t) &&
            ...
            return (
              this.ba &&
                Promise.resolve().then(function () {
                  "function" == typeof t
                    ? t(al(i))
                    : "function" == typeof t.next && t.next(al(i));
                }),
              this.Pa(t, e, n)
            );
          }),
          ...
          (t.Uc = function (t, e) {
            var n = this;
            return this.h.then(function () {
              return ol(n, Xs(n.a, Hs, { email: t, password: e }));
            });
          }),
          (t.dc = function (t, e) {
            var n = this;
            return this.h.then(function () {
              return ol(n, Xs(n.a, ms, { email: t, password: e }));
            });
          }),
          (t.ab = function (t) {
            var e = this;
            return this.h.then(function () {
              return ol(e, t.ka(e.a));
            });
          }),
          (t.Sc = function (t) {
            return (
          ...
          (t.Ab = function () {
            ...
            return this.h.then(function () {
              ...
              return ol(n, n.a.Ab()).then(function (t) {
                var e = t.user;
          ...
          (t.getUid = function () {
            return (al(this) && al(this).uid) || null;
          }),
          (t.cc = function (t) {
            this.addAuthTokenListener(t),
              this.u++,
              0 < this.u && al(this) && gh(al(this));
          }),
          (t.Pc = function (e) {
            var n = this;
            V(this.s, function (t) {
          ...
          (t.delete = function () {
            ...
            return (
              (this.P = []),
              this.i &&
                (t = this.i).b.removeListener(Wh("local"), t.a, this.ja),
          ...
          (t.Wc = function (t, e) {
            return cl(this, Kc(this, t, e, b(this.ab, this)));
          }),
          (t.Vc = function (n, i) {
            var r = this;
            return cl(
        ...
        (ll.prototype.render = function (t, e) {
          ...
          (ll.prototype.reset = function (t) {
            var e = dl(this, t);
            (t = pl(t)), e && t && (e.delete(), delete this.a[t]);
          }),
          (ll.prototype.getResponse = function (t) {
            return (t = dl(this, t)) ? t.getResponse() : null;
          }),
          (ll.prototype.execute = function (t) {
            (t = dl(this, t)) && t.execute();
          }),
          (vl.prototype.getResponse = function () {
            return ml(this), this.b;
          }),
          ...
          Vi(gl, "FACTOR_ID", "phone"),
          (bl.prototype.g = function () {
            return ye((fl = fl || new ll()));
          }),
          ...
          return new fe(function (t, e) {
            ...
            !l.grecaptcha || (r !== o.f && !o.b)
              ? ((l[o.a] = function () {
                ...
                ye(Pa(It(Il, { onload: o.a, hl: r || "" }))).o(function () {
                  clearTimeout(i),
                    e(
                      new T(
                        "internal-error",
        ...
        function Al(t, e, n, i, r, o, a) {
          ...
          if (((this.i = "invisible" === this.a[_l]), !l.document))
            throw new T(
              "operation-not-supported-in-this-environment",
        ...
        function Dl(t, e, n) {
          ...
          (o = $l.default.SDK_VERSION ? mi($l.default.SDK_VERSION, o) : null),
            Al.call(
              this,
              n,
              t,
        ...
        ((t = Al.prototype).Ia = function () {
          ...
          (t.reset = function () {
            Rl(this), null !== this.c && this.g.reset(this.c);
          }),
          (t.clear = function () {
            Rl(this), (this.J = !0), this.m.c();
        ...
        function zl(t, e, n) {
          function i() {
            var t = Array.prototype.slice.call(arguments);
            return Pl(o, n, t), e.apply(this, t);
          }
          if (!n) return e;
          var r,
        ...
        Xl($h.prototype, {
          kb: { name: "applyActionCode", j: [xl("code")] },
          Sa: { name: "checkActionCode", j: [xl("code")] },
          ob: {
            name: "confirmPasswordReset",
            j: [xl("code"), xl("newPassword")],
          },
          dc: {
            name: "createUserWithEmailAndPassword",
            j: [xl("email"), xl("password")],
          },
          hc: { name: "fetchSignInMethodsForEmail", j: [xl("email")] },
          ra: { name: "getRedirectResult", j: [] },
          Bc: { name: "isSignInWithEmailLink", j: [xl("emailLink")] },
          Hc: {
            name: "onAuthStateChanged",
            j: [
              Wl(jl(), Ul(), "nextOrObserver"),
              Ul("opt_error", !0),
              Ul("opt_completed", !0),
            ],
          },
          ...
          xb: {
            ...
            j: [xl("email"), jl("actionCodeSettings")],
          },
          yb: { name: "setPersistence", j: [xl("persistence")] },
          Sc: { name: "signInAndRetrieveDataWithCredential", j: [Fl()] },
          Ab: { name: "signInAnonymously", j: [] },
          ab: { name: "signInWithCredential", j: [Fl()] },
          Tc: { name: "signInWithCustomToken", j: [xl("token")] },
          Uc: {
          ...
          Vc: {
            ...
            j: [xl("email"), xl("emailLink", !0)],
          },
          Wc: { name: "signInWithPhoneNumber", j: [xl("phoneNumber"), Bl()] },
          Xc: { name: "signInWithPopup", j: [Hl()] },
          Yc: { name: "signInWithRedirect", j: [Hl()] },
          dd: {
          ...
          Bb: { name: "signOut", j: [] },
          toJSON: { name: "toJSON", j: [xl(null, !0)] },
          fd: { name: "useDeviceLanguage", j: [] },
          gd: { name: "useEmulator", j: [xl("url"), jl("options", !0)] },
          jd: { name: "verifyPasswordResetCode", j: [xl("code")] },
        }),
          Jl($h.prototype, {
            lc: { name: "languageCode", lb: Wl(xl(), Vl(), "languageCode") },
            ti: { name: "tenantId", lb: Wl(xl(), Vl(), "tenantId") },
          }),
          (($h.Persistence = Ku).LOCAL = "local"),
          ($h.Persistence.SESSION = "session"),
          ($h.Persistence.NONE = "none"),
          Xl(hh.prototype, {
            delete: { name: "delete", j: [] },
            oc: { name: "getIdTokenResult", j: [Ml("opt_forceRefresh", !0)] },
            I: { name: "getIdToken", j: [Ml("opt_forceRefresh", !0)] },
            Cc: { name: "linkAndRetrieveDataWithCredential", j: [Fl()] },
            rb: { name: "linkWithCredential", j: [Fl()] },
            Dc: { name: "linkWithPhoneNumber", j: [xl("phoneNumber"), Bl()] },
            Ec: { name: "linkWithPopup", j: [Hl()] },
            Fc: { name: "linkWithRedirect", j: [Hl()] },
            Lc: {
              name: "reauthenticateAndRetrieveDataWithCredential",
              j: [Fl()],
            },
            ub: { name: "reauthenticateWithCredential", j: [Fl()] },
            Mc: {
              name: "reauthenticateWithPhoneNumber",
              j: [xl("phoneNumber"), Bl()],
            },
            Nc: { name: "reauthenticateWithPopup", j: [Hl()] },
            Oc: { name: "reauthenticateWithRedirect", j: [Hl()] },
            ...
            toJSON: { name: "toJSON", j: [xl(null, !0)] },
            cd: { name: "unlink", j: [xl("provider")] },
            Cb: { name: "updateEmail", j: [xl("email")] },
            Db: { name: "updatePassword", j: [xl("password")] },
            ed: { name: "updatePhoneNumber", j: [Fl("phone")] },
            Eb: { name: "updateProfile", j: [jl("profile")] },
            Fb: {
          ...
          Jl(qc.prototype, {
            appVerificationDisabled: {
              ...
              lb: Ml("appVerificationDisabledForTesting"),
            },
          }),
          Xl(Hc.prototype, {
            confirm: { name: "confirm", j: [xl("verificationCode")] },
          }),
          Yl(
            Zr,
            "fromJSON",
          ...
          Yl(
            ...
            [xl("email"), xl("password")]
          ),
          Xl(bo.prototype, { w: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(co.prototype, {
            Ca: { name: "addScope", j: [xl("scope")] },
            Ka: {
              name: "setCustomParameters",
              j: [jl("customOAuthParameters")],
            },
          }),
          Yl(co, "credential", ho, [Wl(xl(), jl(), "token")]),
          Yl(wo, "credentialWithLink", Io, [xl("email"), xl("emailLink")]),
          Xl(lo.prototype, {
            Ca: { name: "addScope", j: [xl("scope")] },
            Ka: {
              name: "setCustomParameters",
          ...
          Yl(lo, "credential", fo, [Wl(xl(), jl(), "token")]),
          Xl(po.prototype, {
            Ca: { name: "addScope", j: [xl("scope")] },
            Ka: {
              name: "setCustomParameters",
          ...
          Yl(po, "credential", vo, [
            Wl(xl(), Wl(jl(), Vl()), "idToken"),
            Wl(xl(), Vl(), "accessToken", !0),
          ]),
          Xl(mo.prototype, {
            Ka: {
              name: "setCustomParameters",
          ...
          Yl(mo, "credential", go, [Wl(xl(), jl(), "token"), xl("secret", !0)]),
          Xl(uo.prototype, {
            Ca: { name: "addScope", j: [xl("scope")] },
            credential: {
              name: "credential",
              j: [
                Wl(xl(), Wl(jl(), Vl()), "optionsOrIdToken"),
                Wl(xl(), Vl(), "accessToken", !0),
              ],
            },
            Ka: {
          ...
          Xl(io.prototype, { w: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(to.prototype, { w: { name: "toJSON", j: [xl(null, !0)] } }),
          Yl(So, "credential", No, [
            xl("verificationId"),
            xl("verificationCode"),
          ]),
                    ...
                    M: function (t) {
                      return (
                        ...
                        (t.session && t.phoneNumber
                          ...
                          ? Kl(t.session, $r) && Gl(t.multiFactorHint)
          ...
          Xl(Eo.prototype, { w: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(T.prototype, { toJSON: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(Mo.prototype, { toJSON: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(xo.prototype, { toJSON: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(Jc.prototype, { toJSON: { name: "toJSON", j: [xl(null, !0)] } }),
          Xl(Bc.prototype, { Rc: { name: "resolveSignIn", j: [ql()] } }),
          Xl(th.prototype, {
            Sb: { name: "getSession", j: [] },
            fc: { name: "enroll", j: [ql(), xl("displayName", !0)] },
            bd: {
              name: "unenroll",
              j: [
                Wl(
          ...
          (function () {
            if (
              void 0 === $l.default ||
              !$l.default.INTERNAL ||
              !$l.default.INTERNAL.registerComponent
            )
              throw Error(
            ...
            Yl(t, "EmailAuthProvider", wo, []),
              Yl(t, "FacebookAuthProvider", co, []),
              Yl(t, "GithubAuthProvider", lo, []),
              Yl(t, "GoogleAuthProvider", po, []),
              Yl(t, "TwitterAuthProvider", mo, []),
              Yl(t, "OAuthProvider", uo, [xl("providerId")]),
              Yl(t, "SAMLAuthProvider", so, [xl("providerId")]),
              Yl(t, "PhoneAuthProvider", So, [
                {
                  name: "auth",
              ...
              Yl(t, "RecaptchaVerifier", Dl, [
                ...
                jl("recaptchaParameters", !0),
                {
                  name: "app",
                  K: "an instance of Firebase App",
                  optional: !0,
                  M: function (t) {
                    return !!(t && t instanceof $l.default.app.App);
                  },
                },
              ]),
              Yl(t, "ActionCodeURL", hr, []),
              ...
              $l.default.registerVersion("@firebase/auth", "0.16.7"),
              $l.default.INTERNAL.extendNamespace({ User: hh });
          })();
      }.apply(
